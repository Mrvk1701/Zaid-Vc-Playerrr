...
💭 **ɪ'ᴍ [{BOT_NAME}](https://t.me/{BOT_USERNAME}) ᴀʟʟᴏᴡꜱ ᴜ ᴘʟᴀʏ ꜱᴏɴɢꜱ ɪɴ ᴠᴄ ᴄʜᴀᴛꜱ ᴘᴏᴡᴇʀᴇᴅ ʙʏ LUCKY ᴍᴜꜱɪᴄ!

☑️ ꜰɪɴᴅ ᴏᴜᴛ ᴀʟʟ ʙᴏᴛꜱ ᴄᴏᴍᴍᴀɴᴅꜱ ᴀɴᴅ ʜᴇʟᴘꜱ ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴏɴ ɪɴʟɪɴᴇ ʙᴜᴛᴛᴏɴꜱ ᴀɴᴅ /help** [.](https://https://telegra.ph/file/0824baeceeb1f6d3223de.jpg)
        ...
        reply_markup=InlineKeyboardMarkup(
            [ 
                ...
                [
                    InlineKeyboardButton(
                        "ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 💫", url="https://t.me/terayaarhoomai")
                ],[
                    InlineKeyboardButton(
                        "⚡ ᴏꜰꜰɪᴄɪᴀʟ ꜱᴜᴘᴘᴏʀᴛ", url=f"https://t.me/terayaarhoomai"
                    ),
                    InlineKeyboardButton(
                        "ᴏꜰꜰɪᴄɪᴀʟ ᴄʜᴀɴɴᴇʟ ☑️", url=f"https://t.me/Maxopeditz")
                ],[
                    InlineKeyboardButton(
...
async def start(client: Client, message: Message):
    ...
    await message.reply_photo(
        photo=f"https://telegra.ph/file/0824baeceeb1f6d3223de.jpg",
        caption=alive,
